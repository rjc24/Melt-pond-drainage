...
def NL_solve(method, HH_0, HH_p, CC_0, CC_p, xx, xin, t1, t2, 
             a_0, a, T_p, params, BC_D, BC_N, alp, G_T = None, G_C = None, 
    ...
    if any(HH_p >= CC_p):
        ...
        a_0, T_f0, T_c0 = int_quad(TT_0, CC_0, xx, xin, a_0, OPT = 2)
        a, T_f, T_c = int_quad(TT, CC, xx, xin, a_0, OPT = 2)
    else:
        j = 0
        T_f0 = 0
        T_c0 = 0
    ...
    Q_0 = Q_Vflux(a_0, T_f0, TT_0, xx, xin, Re, Cr, T_p, lam, a_t, T_c0)
    Q = Q_Vflux(a, T_f, TT, xx, xin, Re, Cr, T_p, lam, a_t, T_c)
