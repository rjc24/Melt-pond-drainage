...
def time_step_1(method, HH_0, CC_0, xx, xin, t1, t2, a_0, Q_T,
    ...
    while diff > tol_g or err > tol:
        ...
        HH, TT, CC, phi, a, err = \
            NL_solve(method, HH_0, HH_p, CC_0, CC_p, xx, xin, 
                     t1, t2, a_0, a, Q_T, params, BC_D, BC_N, alp, 
    ...
    while n < max_t_iter:
        ...
        HH_f, TT_f, CC_f, phi_f, a_f, err_f = \
            time_step_1(method, HH_0, CC_0, xx, xin, t1, t2, a_0, 
                Q_T, params, BC_D, BC_N, alp, G_Tf, G_Cf,
        ...
        if ~np.isnan(HH_f).any():
            ...
            HH_h, TT_h, CC_h, phi_h, err_h_arr[:] = \
                HH_f, TT_f, CC_f, phi_f, err_f
