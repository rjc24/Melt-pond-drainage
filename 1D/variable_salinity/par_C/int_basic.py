...
def int_quad(TT, CC, xx, xin, a_0, OPT = 1):
    ...
    # the temperature / salinity at the interface position (T_f), estimates of
    # the temperature and salinity in the liquid portion of the cell 
    # containing the interface (T_c, C_c respectively).
    #=========================================================================
