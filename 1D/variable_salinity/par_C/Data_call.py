...
def data_call(run, method, HH_0, TT_0, CC_0, xx, xin, tt, tt_shots, 
              dt_max, a_0, p_vals, params, BC_D, BC_N, alp, D_n,
    ...
    T_p, C_p = p_vals[:]    # pond temp/salinity
...
#        print('iteration', i)
        ...
        HH, TT, CC, phi, a_n, t_1, t_2, err_est, n = \
            time_step_A('Crank', HH_p, CC_p, xx, xin, t_1, t_2, 
                  dt_max, a_0, p_vals, params, BC_D, BC_N,
                  alp, D_n, omega_s = omega_s, omega_i = omega_i, 
    ...
    a_t_file = open(path_cont+'a_t.asc', 'w+')
    ...
    Re_file = open(path_cont+'Re.asc', 'w+')    
    Pr_file = open(path_cont+'Pr.asc', 'w+')
    T_p_file = open(path_cont+'T_p.asc', 'w+')
    C_p_file = open(path_cont+'C_p.asc', 'w+')
    lam_file = open(path_cont+'lam.asc', 'w+')
    ...
    # Dirichlet
    T_L_file = open(path_cont+'T_L.asc', 'w+')
    T_R_file = open(path_cont+'T_R.asc', 'w+')
    H_L_file = open(path_cont+'H_L.asc', 'w+')
    H_R_file = open(path_cont+'H_R.asc', 'w+')
    C_L_file = open(path_cont+'C_L.asc', 'w+')
    C_R_file = open(path_cont+'C_R.asc', 'w+')
    phi_L_file = open(path_cont+'phi_L.asc', 'w+')
    phi_R_file = open(path_cont+'phi_R.asc', 'w+')
    
    # Neumann
    FT_L_file = open(path_cont+'FT_L.asc', 'w+')
    FT_R_file = open(path_cont+'FT_R.asc', 'w+')
    FH_L_file = open(path_cont+'FH_L.asc', 'w+')
    FH_R_file = open(path_cont+'FH_R.asc', 'w+')
    FC_L_file = open(path_cont+'FC_L.asc', 'w+')
    FC_R_file = open(path_cont+'FC_R.asc', 'w+')
    Fphi_L_file = open(path_cont+'Fphi_L.asc', 'w+')
    Fphi_R_file = open(path_cont+'Fphi_R.asc', 'w+')
