...
def time_step_1(method, HH_0, CC_0, xx, xin, t1, t2, a_0, p_vals,
                params, BC_D, BC_N, alp, D_n, G_T = None, G_C = None, 
    ...
    while diff > tol_g or err > tol:
        ...
        HH, TT, CC, phi, a, err = \
            NL_solve(method, HH_0, HH_p, CC_0, CC_p, xx, xin, 
                     t1, t2, a_0, a, p_vals, params, BC_D, BC_N, alp, D_n,
    ...
    return HH, TT, CC, phi, a, err    #  n_temp, a_temp,


def time_step_A(method, HH_0, CC_0, xx, xin, t1, t2, dt_max,
              a_0, p_vals, params, BC_D, BC_N, 
              alp, D_n, omega_s = 1, omega_i = 0.5, 
    ...
    while n < max_t_iter:
        ...
        HH_f, TT_f, CC_f, phi_f, a_f, err_f = \
            time_step_1(method, HH_0, CC_0, xx, xin, t1, t2, a_0, 
                p_vals, params, BC_D, BC_N, alp, D_n, G_Tf, G_Cf,
            ...
            for i in range(2):
                ...
                HH_h, TT_h, CC_h, phi_h, a_h, err_h_arr[i] = \
                    time_step_1(method, HH_0h, CC_0h, xx, xin, t_a, t_b,
                        a_a, p_vals, params, BC_D, BC_N, alp, D_n,
